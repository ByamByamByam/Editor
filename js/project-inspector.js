...
function getChapterSplitMessageIndex(
    chapter
) {
    ...
    /*
        일반 편집에서는 selectedMessageId를 사용하고,
        연출 편집에서는 선택 구간의 시작 메시지를 사용한다.
    */
    const selectedRange =
    ...
    if (splitChapterBtn) {
        ...
        splitChapterBtn.title =
            canSplit
                ...
                : "첫 메시지 이외의 메시지 또는 메시지 구간을 선택해주세요.";
